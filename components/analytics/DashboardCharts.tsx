...
export function DashboardCharts({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="bg-gray-500/45 rounded-lg shadow p-6">
      ...
      {clientAcquisition && clientAcquisition.length > 0 && (
        <div className="bg-gray-500/45 rounded-lg shadow p-6 lg:col-span-2">
...
export function StatsCards({ stats }: StatsCardsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
      {cards.map((card) => (
        <div key={card.title} className="bg-gray-500/45 rounded-lg shadow p-6">
    ...
    <div className="flex items-center gap-3">
      <div className="flex-1">
        <div className="flex items-center justify-between mb-1">
          ...
          <span
            className={`text-sm font-semibold px-2 py-1 rounded ${getColor(score)}`}
          >
            {getStatus(score)}
          </span>
        </div>
