  ...
  return (
    <ClerkProvider>
      <html className="scrollbar-hide " lang="en">
        <body className={`${epilogue.className} max-w-7xl mx-auto tracking-widest bg-gradient-to-b from-black from-20% via-[#595757] via-50% to-zinc-900 to-80%  text-gray-200`}> {/* Choose bg colur if this or bg-zinc-950 */}
          <Navbar />
