                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={e => setFormData(prev => ({ ...prev, vercelProjectId: e.target.value }))}
                            className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                            placeholder="prj_..."
                        />
                        <p className="text-xs text-gray-500 mt-1">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={e => setFormData(prev => ({ ...prev, googleAnalyticsPropertyId: e.target.value }))}
                            className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                ...
                <div className="space-y-3">
                    {initialDeploymentUrl ? (
                        <>
                            ...
                            {initialVercelProjectId && (
                                <div>
                                    ...
                                    <p className="text-gray-900 font-mono text-sm mt-1">{initialVercelProjectId}</p>
                                </div>
                            )}

                            {initialGAPropertyId && (
                                <div>
                                    <p className="text-sm text-gray-600">Google Analytics Property ID</p>
                                    <p className="text-gray-900 font-mono text-sm mt-1">{initialGAPropertyId}</p>
                                </div>
                            )}
                        </>
                    ) : (
                        <div className="text-center py-8 text-gray-500">
                            ...
                            <p className="text-sm mt-1">Add the website URL after deploying to Vercel</p>
                        </div>
                    )}
                </div>
            )}
