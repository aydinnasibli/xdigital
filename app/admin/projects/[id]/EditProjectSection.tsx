...
export default function EditProjectSection({
  ...
  return (
    <div className="bg-black border border-gray-400 rounded-lg shadow p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        {!isEditing ? (
          <button
            ...
            className="px-4 py-2 text-sm bg-gray-700 text-gray-200 rounded-lg hover:bg-gray-800 transition-all duration-300 hover:cursor-pointer"
          >
            Edit Details
          </button>
        ) : (
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-gray-700 text-sm border border-gray-300 rounded-lg hover:bg-gray-800 hover:cursor-pointer transition-all duration-300"
              disabled={loading}
            >
              Cancel
            </button>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 capitalize">{project.package}</p>
            </div>
          </div>
        </div>
      )}
