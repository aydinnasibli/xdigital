    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Update Status */}
          <div className=" rounded-lg shadow border border-gray-400 p-6">
          ...
          {/* Tasks */}
          <TasksSection projectId={project._id} tasks={tasks} />

          {/* Files */}
          <FilesSection projectId={project._id} files={files} />
        </div>
...
function InfoItem({
  ...
  return (
    <div>
      ...
      <p
        className={`font-medium text-gray-900 mt-1 ${capitalize ? "capitalize" : ""}`}
      >
        {value}
      </p>
    </div>
