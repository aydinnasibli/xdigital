  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            >
              ...
              <option value={ProjectStatus.PENDING} className="bg-gray-900">
                Pending
              </option>
              <option value={ProjectStatus.IN_PROGRESS} className="bg-gray-900">
                In Progress
              </option>
              <option value={ProjectStatus.REVIEW} className="bg-gray-900">
                Review
              </option>
              <option value={ProjectStatus.COMPLETED} className="bg-gray-900">
                Completed
              </option>
              <option value={ProjectStatus.ON_HOLD} className="bg-gray-900">
                On Hold
              </option>
            </select>
          </div>
          ...
          <div>
            ...
            >
              ...
              <option
                value={ServiceType.WEB_DEVELOPMENT}
                className="bg-gray-900"
              >
                Web Development
              </option>
              <option value={ServiceType.SMM} className="bg-gray-900">
                Social Media Marketing
              </option>
              <option
                value={ServiceType.DIGITAL_SOLUTIONS}
                className="bg-gray-900"
              >
                Digital Solutions
              </option>
      ...
      <div className="bg-white/5 backdrop-blur-sm border border-gray-800/50 rounded-xl p-4">
        <p className="text-sm text-gray-300">
          Showing <strong className="text-white">{projects.length}</strong>{" "}
          projects
          {selectedProjects.length > 0 && (
            <span className="ml-2">
              ·{" "}
